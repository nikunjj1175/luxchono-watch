...
function AddAddressDrawer() {
    ...
    const [AddAddress, { isLoading: AddAddressFetching }] = useAddAddressMutation();
    const [EditAddress, { isLoading: EditAddressFetching }] = useEditAddressMutation();
    ...
    useEffect(() => {
        ...
        setSelectedStateValues(defaultAddress?.state ? { value: defaultAddress?.state, label: defaultAddress?.state } : null)
        setSelectedAddTypeValues(defaultAddress?.addressType ? { value: defaultAddress?.addressType, label: defaultAddress?.addressType } : null)
    ...
    const Address = useFormik({
        ...
        validationSchema: Yup.object().shape({
            ...
            phoneNo: Yup.number().required("Phone Number is Requried")
            ...
            pincode: Yup.number().required("Pincode is Required")
                .test('Enter valid Pincode number', value =>
                    !value || REGEX.PINCODE.test(value.toString())
                ),
        }),
    ...
    return (
        <>
            <Drawer
                ...
                <form onSubmit={Address.handleSubmit} className='add_addres_drawer_div' style={{ width: "390px" }}>
                    ...
                    <div className="add_address_drawer_header_wrapper">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: "100%" }}>
                            ...
                            <div onClick={onCancel}>
                                <CloseIcon className="!cursor-pointer text-black mr-[0.5rem]  close_icon" style={{ cursor: "pointer" }} />
                            </div>
                        </div>
                    </div>

                    <div className='add_address_div' style={{ overflow: "auto", paddingBottom: "6rem" }}>
                            ...
                            <div className='first_from_value'>
                                ...
                                <div className='flex flex-col gap-[3px]'>
                                    ...
                                    <TextFields
                                        ...
                                        helperText={Address.touched.fullName && Address.errors.fullName}
                                        className={"nametext"}
                                ...
                                <div className='flex flex-col gap-[3px] mt-[0.8rem]'>
                                    ...
                                    <TextFields
                                        ...
                                        onChange={Address.handleChange}
                                        helperText={Address.touched.phoneNo && Address.errors.phoneNo}
                                        type={"number"}
                                        className={"nametext"}
                                ...
                                <div className='flex flex-col gap-[3px]  mt-[0.8rem]'>
                                    ...
                                    {Address.touched.addressType && Address.errors.addressType && (
                            ...
                            <div className='secound_from_value'>
                                ...
                                <div className='flex flex-col gap-[3px]  mt-[0.8rem]'>
                                    ...
                                    <TextFields
                                        ...
                                        onChange={Address.handleChange}
                                        helperText={Address.touched.pincode && Address.errors.pincode}
                                        type={"number"}
                                        className={"nametext"}
                    ...
                    <div className="add_address_drawer_footer">
                        <div className='flex gap-[10px] justify-end'>
                            <Buttons onClick={onCancel} type={'submit'} text={"Cancel"} variant={'outlined'} className={'add_close_btn'} />
                            <Buttons type={'submit'} text={DialogOpen?.data?._id ? "Edit" : "Add"} variant={'contained'} className={'Add_btn'} />
                        </div>
                    </div>
