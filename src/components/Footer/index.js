...
export default function Footer() {
    return (
        <>
                ...
                <Grid container spacing={3} className="footer_grid bg-darkbg" >
                    <Grid item xs={12} lg={3} md={4} sm={4} >
                        ...
                        <div className='flex flex-col p-[1rem] gap-[0.5rem] justify-center'>
                            ...
                            <div>
                                <span className='text-[20px] text-white    capitalize' style={{ fontWeight: "600" }}> {"Subscribe to our email alerts!"}</span>
                            </div>
                            ...
                            <div className='flex gap-[10px]'>
                                ...
                                <Buttons
                                    ...
                                    endIcon={<SendIcon className='text-secondary' style={{ fontSize: "20px" }} />}
                                >
                    ...
                    <Grid item xs={12} lg={3} md={4} sm={4} >
                        ...
                        <div className='flex flex-col p-[1rem] gap-[0.5rem] justify-center'>
                            ...
                            <div>
                                <span className='text-[18px] text-white capitalize underline decoration-secondary' style={{ fontWeight: "600" }}> {"customer Services"}</span>
                            </div>

                            <div className='flex gap-[10px]'>
                                <ul className='flex flex-col gap-[5px]' >
                                    <li className='text-white text-[15px] li_underline' style={{ fontWeight: "300" }}>{"Payment Options"}</li>
                                    <li className='text-white text-[15px] li_underline' style={{ fontWeight: "300" }}> {"Track Order"}</li>
                                    <li className='text-white text-[15px] li_underline' style={{ fontWeight: "300" }}>{"Encircle Program"}</li>
                                    <li className='text-white text-[15px] li_underline' style={{ fontWeight: "300" }}>{"Why Buy Direct"}</li>
                                    <li className='text-white text-[15px] li_underline' style={{ fontWeight: "300" }}>{"Bulk Orders"}</li>
                                    <li className='text-white text-[15px] li_underline' style={{ fontWeight: "300" }}>{"Warranty & Support"}</li>
                    ...
                    <Grid item xs={12} lg={3} md={4} sm={4} >
                        ...
                        <div className='flex flex-col p-[1rem] gap-[0.5rem] justify-center'>
                            ...
                            <div>
                                <span className='text-[18px] text-white capitalize underline decoration-secondary' style={{ fontWeight: "600" }}> {"Contact Us"}</span>
                            </div>
                            ...
                            <div className='mt-[1rem]'>
                                <span className='text-[18px] text-white capitalize underline decoration-secondary' style={{ fontWeight: "600" }}> {"Policies"}</span>
                            </div>
                            <div className='flex gap-[10px]'>
                                <ul className='flex flex-col gap-[5px]' >
                    ...
                    <Grid item xs={12} lg={3} md={4} sm={4} >
                        ...
                        <div className='flex flex-col p-[1rem] gap-[0.5rem] justify-center'>
                            <div>
                                <span className='text-[18px] text-white capitalize underline decoration-secondary' style={{ fontWeight: "600" }}> {"Let's get social"}</span>
                            </div>
                            <div className='flex gap-[10px]'>
            ...
            <div className='bg-darkbg flex justify-center items-center h-[4rem] ' style={{ borderTop: "0.5px solid #A9A9A9" }} >
                <span className='text-lighttext' style={{ fontWeight: "500" }}>&#169; 2024 Luxchono Limited. All Rights Reserved</span>
            </div>
