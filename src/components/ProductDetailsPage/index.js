...
import { useGetLikeProductQuery, useGetProductQuery, useGetSingleProductQuery, useLikeProductMutation } from '../../api/Product';
...
const ProductDetails = () => {
    ...
    const { data: SingleProductApiData, isFetching: SingleProductFetching } = useGetSingleProductQuery(productId);
    ...
    useEffect(() => {
        ...
        actions.loder.setLoading(CartProductFetching || SingleProductFetching || AddToCartFetching);
    ...
    return (
        <>
            <div style={{ marginTop: "5rem", minHeight: "60vh" }} className='product_details'>
                        ...
                        <Grid container spacing={4} className="pwatch_grid" >
                          ...
                          /> */}
                                    ...
                                    <div className='mt-[1rem] flex flex-col gap-[-3px]'>
                                        <span className='text-[25px]' style={{ fontWeight: "600" }}>{singleProductData?.name}</span>
                                    ...
                                    <div className='mt-[0.7rem]'>
                                        <div className='flex gap-[8px] items-center'>
                                            <span className='text-[20px] text-main' style={{ fontWeight: "600" }}>{singleProductData?.brand?.name}</span>
                                            <span className='text-[15px] ' style={{ fontWeight: "600" }}>{singleProductData?.warranty}</span>
                                        </div>
                                    </div>
